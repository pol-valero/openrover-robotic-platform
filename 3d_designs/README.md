...
The cases for the custom remote control PCB module and ESP32S3-8048 touchscreen are in this [Fusion360 design file](RC_touchscreen_cases_Spektrum_DX8.f3d). These cases adapt to the shape of the Spektrum DX8 remote, allowing to place the custom RC module and touchscreen as add-ons. 
...
![Alt text](/images/rc_cases_design.png)